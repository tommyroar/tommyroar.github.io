...
export declare const DEFAULT_AVAILABLE_THEMES: {
  light: ("sqlserver" | "chrome" | "clouds" | "crimson_editor" | "dawn" | "dreamweaver" | "eclipse" | "github" | "iplastic" | "solarized_light" | "textmate" | "tomorrow" | "xcode" | "kuroir" | "katzenmilch")[];
  dark: ("terminal" | "ambiance" | "chaos" | "clouds_midnight" | "dracula" | "cobalt" | "gruvbox" | "gob" | "idle_fingers" | "kr_theme" | "merbivore" | "merbivore_soft" | "mono_industrial" | "monokai" | "nord_dark" | "pastel_on_dark" | "solarized_dark" | "tomorrow_night" | "tomorrow_night_blue" | "tomorrow_night_bright" | "tomorrow_night_eighties" | "twilight" | "vibrant_ink")[];
};
...
export declare function getStatusButtonId({
  paneId,
  paneStatus
}: {
  paneId?: string;
