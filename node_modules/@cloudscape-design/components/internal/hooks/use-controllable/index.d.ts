 ...
 */
export declare function useControllable<ValueType>(controlledValue: ValueType, handler: ((...args: any[]) => unknown) | undefined, defaultValue: ValueType, {
  componentName,
  changeHandler,
  controlledProp
}: PropertyDescription): readonly [ValueType, (newValue: React.SetStateAction<ValueType>) => void];
export {};