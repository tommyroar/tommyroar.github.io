...
export declare const useFunnelSubStep: () => import("../context/analytics-context").FunnelSubStepContextValue | {
  subStepIdentifier?: import("../interfaces").AnalyticsMetadata["instanceIdentifier"];
  subStepErrorContext?: import("../interfaces").AnalyticsMetadata["errorContext"];
  subStepId: string;
  ...
  focusCleanupFunction: import("react").MutableRefObject<undefined | (() => void)>;
