...
class DropdownContentWrapper extends selectors_1.ComponentWrapper {
    ...
    findHighlightedAriaLiveRegion() {
        var _a, _b;
        return (_b = (_a = this.findHighlightedOption()) === null || _a === void 0 ? void 0 : _a.findByClassName(styles_selectors_js_4.default['screenreader-content'])) !== null && _b !== void 0 ? _b : null;
    }
    /**
     ...
     */
    findSelectAll() {
        return this.find(`.${styles_selectors_js_4.default['select-all']}`);
    }
}
