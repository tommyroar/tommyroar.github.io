...
export default class ListWrapper extends ComponentWrapper {
   ...
   */
  findItems(): import("@cloudscape-design/test-utils-core/selectors").MultiElementWrapper<ListItemWrapper>;
  /**
   * Returns an item for a given index.
   *
   * @param index 1-based index of the item to return.
   */
  findItemByIndex(index: number): ListItemWrapper;
  /**
   * Returns an item for a given id.
   *
   */
  findItemById(id: string): ListItemWrapper;
}