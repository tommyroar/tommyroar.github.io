...
export declare const copyPreferences: ({
  pageSize,
  wrapLines,
  stripedRows,
  contentDensity,
...
export declare const ModalContentLayout: ({
  left,
  right
}: ModalContentLayoutProps) => JSX.Element;
interface PageSizePreferenceProps extends CollectionPreferencesProps.PageSizePreference {
  onChange: (value: number) => void;
  value?: number;
}
export declare const PageSizePreference: ({
  title,
  options,
  value,
  onChange
}: PageSizePreferenceProps) => JSX.Element;
interface WrapLinesPreferenceProps extends CollectionPreferencesProps.WrapLinesPreference {
  onChange: (value: boolean) => void;
  value?: boolean;
}
export declare const WrapLinesPreference: ({
  label,
  description,
  value,
  onChange
}: WrapLinesPreferenceProps) => JSX.Element;
interface StripedRowsPreferenceProps extends CollectionPreferencesProps.StripedRowsPreference {
  onChange: (value: boolean) => void;
  value?: boolean;
}
export declare function StripedRowsPreference({
  label,
  description,
  value,
  onChange
}: StripedRowsPreferenceProps): JSX.Element;
...
export declare const ContentDensityPreference: ({
  label,
  description,
  value,
  onChange
}: ContentDensityPreferenceProps) => JSX.Element;
...
export declare const StickyColumnsPreference: ({
  firstColumns,
  lastColumns,
  onChange,
  value
...
export declare const CustomPreference: ({
  value,
  customPreference,
  onChange
}: CustomPreferenceProps) => JSX.Element | null;
export {};