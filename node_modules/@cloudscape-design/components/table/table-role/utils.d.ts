export declare function getClosestCell(element: Element): null | HTMLTableCellElement;
 ...
 */
export declare function findTableRowByAriaRowIndex(table: null | HTMLTableElement, targetAriaRowIndex: number, delta: number): HTMLTableRowElement | null;
/**
