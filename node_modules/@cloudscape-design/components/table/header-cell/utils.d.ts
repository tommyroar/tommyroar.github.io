...
export declare const getSortingColumnId: <T>(columnDefinitions?: ReadonlyArray<TableProps.ColumnDefinition<T>>, sortingColumn?: TableProps.SortingColumn<T>) => string | null;